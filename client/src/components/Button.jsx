...
const Button = ({ btnText, btnSize, variant, btnIcon, iconPosition, onClick }) => {
  ...
  const variantClasses = {
    ...
    outline: "border-1 border-purple-600 text-purple-700 hover:bg-purple-600 hover:text-white",
  };
  ...
  return (
    <button
      className={`${sizeClasses[btnSize]} ${variantClasses[variant]} flex justify-center items-center cursor-pointer rounded-lg font-medium shadow-lg transition`}
      onClick={onClick}
    >
